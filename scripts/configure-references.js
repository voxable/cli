...
// @see https://medium.com/ah-technology/a-guide-through-the-wild-wild-west-of-setting-up-a-mono-repo-with-typescript-lerna-and-yarn-ed6a1e5467a
...
(async function() {
  ...
  let depthTree = lines.slice(1, lines.length - 2).join('\n');
  // depthTree = `{${depthTree}}` // This seems necessary, sometimes?
